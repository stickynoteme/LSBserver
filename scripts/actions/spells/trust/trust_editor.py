...
GAMBIT_PALETTE = {
    ...
    "🏥 Healing - Job Abilities": [
        ...
        {"name": "Curing Waltz (HP < 50%)", "desc": "Use highest Curing Waltz on party member below 50% HP", "t": "PARTY", "c": "HPP_LT", "c_arg": "50", "r": "JA", "s": "HIGHEST_WALTZ", "s_arg": "xi.ja.CURING_WALTZ"},
    ...
    "💃 Dancer Abilities": [
        {"name": "Best Samba (No Samba)", "desc": "Use the best Samba for the situation", "t": "SELF", "c": "NO_SAMBA", "c_arg": "0", "r": "JA", "s": "BEST_SAMBA", "s_arg": "xi.ja.DRAIN_SAMBA"},
    ...
    "🌍 Geomancer Abilities": [
        {"name": "Best Indi Buff", "desc": "Cast best Indi spell for situation", "t": "SELF", "c": "NOT_STATUS", "c_arg": "xi.effect.COLURE_ACTIVE", "r": "MA", "s": "BEST_INDI", "s_arg": "xi.magic.spellFamily.NONE"},
        ...
        {"name": "Entrusted Indi", "desc": "Cast entrusted Indi buff on ally", "t": "SELF", "c": "STATUS", "c_arg": "xi.effect.ENTRUST", "r": "MA", "s": "ENTRUSTED", "s_arg": "xi.magic.spellFamily.INDI_BUFF"},
    ],
    "🌪️ Scholar Abilities": [
        ...
        {"name": "Storm Day", "desc": "Cast appropriate Storm spell based on day", "t": "SELF", "c": "NO_STORM", "c_arg": "0", "r": "MA", "s": "STORM_DAY", "s_arg": "0"},
    ],
    ...
    "🔮 Offensive Magic - Nukes": [
        {"name": "Magic Burst", "desc": "Cast appropriate nuke spell to magic burst", "t": "TARGET", "c": "MB_AVAILABLE", "c_arg": "0", "r": "MA", "s": "MB_ELEMENT", "s_arg": "xi.magic.spellFamily.NONE"},
        {"name": "Nuke Best Element", "desc": "Cast nuke with best element vs target", "t": "TARGET", "c": "NOT_SC_AVAILABLE", "c_arg": "0", "r": "MA", "s": "BEST_AGAINST_TARGET", "s_arg": "0"},
        ...
        {"name": "Helix Day", "desc": "Cast appropriate Helix spell based on day", "t": "TARGET", "c": "NOT_STATUS", "c_arg": "xi.effect.HELIX", "r": "MA", "s": "HELIX_DAY", "s_arg": "0"},
    ],
    ...
    "🎯 Situational - Enemy Type": [
        {"name": "Holy Circle (vs Undead)", "desc": "Use Holy Circle when fighting undead", "t": "TARGET", "c": "IS_ECOSYSTEM", "c_arg": "xi.ecosystem.UNDEAD", "r": "JA", "s": "SPECIFIC", "s_arg": "xi.ja.HOLY_CIRCLE"},
        {"name": "Ancient Circle (vs Dragon)", "desc": "Use Ancient Circle when fighting dragons", "t": "TARGET", "c": "IS_ECOSYSTEM", "c_arg": "xi.ecosystem.DRAGON", "r": "JA", "s": "SPECIFIC", "s_arg": "xi.ja.ANCIENT_CIRCLE"},
    ],
...
class TrustEditor(tk.Tk):
    ...
    def create_general_tab(self):
        ...
        gear_frame = ttk.LabelFrame(
            content_frame, text="Faux Gear (Look + Mods)", padding=10
        )
    ...
    def apply_job_template(self):
        ...
        if not main_job:
            messagebox.showwarning(
                "Select a Job",
                "Choose a main job before applying a player-like preset.",
            )
            return
